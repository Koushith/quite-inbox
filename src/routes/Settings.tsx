              ...
              <CardHeader className="pb-3 bg-white">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">Protect important emails from bulk actions</p>
                  </div>
                </div>
              </CardHeader>
              ...
              <CardHeader className="pb-3 bg-white">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600 mt-0.5">Mark important senders (banks, gov, etc.)</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4 p-5">
